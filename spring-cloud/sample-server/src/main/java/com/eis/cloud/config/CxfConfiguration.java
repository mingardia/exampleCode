...
public class CxfConfiguration {
    ...
    public Server jaxRsServer() {
        ...
        Collection serviceBeanMap = ctx.getBeansWithAnnotation(Path.class).values();

        // Find all beans annotated with @Path
        List<Object> serviceBeans = new ArrayList<>(serviceBeanMap);
